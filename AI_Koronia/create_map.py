...
markers = [
    {
        ...
        "description": "Η γεωργία στην περιοχή χρησιμοποιεί αλόγιστα τις υδάτινες πηγές, με αποτέλεσμα τη μείωση της στάθμης της λίμνης. Περίπου 2300 παράνομες γεωτρήσεις τροφοδοτούνται από τον υπόγειο υδροφορέα.",
        "coords": [40.685742, 23.147035]
    },
    {
        "category": "Αίτια Υποβάθμισης",
        "title": "Βιομηχανική και αγροτική ρύπανση",
        "description": "Απόβλητα από βιομηχανικές μονάδες και γεωργικές δραστηριότητες (φυτοφάρμακα, λιπάσματα) καταλήγουν στη λίμνη, προκαλώντας ευτροφισμό.",
        "coords": [40.706203, 23.126794]
    },
    {
        "category": "Αίτια Υποβάθμισης",
        "title": "Κτηνοτροφία",
        "description": "Η αυξημένη συγκέντρωση αζωτούχων ενώσεων από τα απόβλητα των κτηνοτροφικών μονάδων επιδεινώνει την κατάσταση.",
        "coords": [40.694260, 23.096810]
    },
    {
        "category": "Αίτια Υποβάθμισης",
        "title": "Αστικά λύματα",
        "description": "Η ανεξέλεγκτη απόρριψη ανεπεξέργαστων οικιακών λυμάτων συμβάλλει στη ρύπανση των υδάτων.",
    ...
    },
    {
        ...
        "description": "Οι κλιματικές αλλαγές επηρεάζουν τη φυσική ανανέωση των υδάτων της λίμνης.",
