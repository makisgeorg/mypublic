...
def train_model(num_epochs):
    ...
    model.save("lake_classification_model.keras")
...
###############################
    ...
    st.write("This process trains the CNN model on your dataset and saves the model as 'lake_classification_model.keras'.")
...
###############################
    ...
    if uploaded_file is not None:
        if uploaded_file.type == "image/gif":
            ...
            @st.cache_resource
            def load_model():
                model = tf.keras.models.load_model("Alake_classification_model.keras", compile=False)
                return model
            model = load_model()
            ...
            @st.cache_resource
            def load_model():
                model = tf.keras.models.load_model("lake_classification_model.keras", compile=False)
                return model
            model = load_model()
